...
export function getIconForProfile(p) {
    switch (p) {
        case GPU_PROFILE_INTEGRATED:
            return Gio.icon_new_for_string(Extension.dir + ICON_INTEL_FILE_NAME);
        case GPU_PROFILE_HYBRID:
            return Gio.icon_new_for_string(Extension.dir + ICON_HYBRID_FILE_NAME);
        case GPU_PROFILE_NVIDIA:
            return Gio.icon_new_for_string(Extension.dir + ICON_NVIDIA_FILE_NAME);
        default:
            return Gio.icon_new_for_string(Extension.dir + ICON_INTEL_FILE_NAME);
    }
}
